<?php require_once 'includes/header.php'; ?>
	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			...
			<!-- /panel-heading -->
				...
				<form class="form-horizontal" action="" method="post" id="getOrderReportForm" style="margin-top: 10px">
				  ...
				  <div class="form-group">
				   ...
				   <!-- div class="col-md-2" style="margin-left: -10px">
				    	<button type="submit" class="btn btn-default " id="generateReportBtn" name="gen"> <i class="glyphicon glyphicon-ok-sign"></i>Generate Report</button>
				    </div> -->
				</form>
	...
	$sql="SELECT * FROM sales WHERE date >= '$start_date' AND date <= '$end_date' ORDER BY id Desc ";
	$generate_query=mysqli_query($connection,$sql);
 				...
 				<?php
                    ...
                    ?>
						...
						<td><a href="sale.php?id=<?php echo $product_id?>">
							<img width='50' height='50' src='images/<?php echo $product['image']; ?>' alt = 'image'>
		...
		<li><a href="total_sales.php?delete=<?php echo $row['id'];?>"><i class="glyphicon glyphicon-trash"></i> Delete</a></li>
				...
				<?php }}	
 				...
 				<?php
                    ...
                    ?>
						<td><a href="sale.php?id=<?php echo $product_id?>">
							<img width='50' height='50' src='images/<?php echo $product['image']; ?>' alt = 'image'></a>
...
?>
					...
					$query="SELECT SUM(total_sales) AS total_sales,SUM(expected_sales) AS expected_sales,cost AS cost ,SUM(quantity) AS quantity FROM sales";
					$sum=mysqli_query($connection,$query);
					while($row=mysqli_fetch_assoc($sum)){
						$quantity=$row['quantity'];
						$cost=$row['cost'];
